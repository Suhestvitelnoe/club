...
@include('cabinet.includes.input_text', array('name'=>'owner', 'val'=>'Владелец'))<br>
</div>

<label class=" control-label col-md-12">Тематика</label>
<select class="form-control form-group col-md-12" name="theme">
...
<label class=" control-label col-md-12" >Дата создания</label>
...
<label class=" control-label col-md-12">Выбрать по количеству участников</label>
<select class="form-control  form-group col-md-12" name="members">
...
<div class="form-group{{ $errors->has('pol') ? ' has-error' : '' }}">
    <label class=" control-label col-md-12">Приватность</label>
